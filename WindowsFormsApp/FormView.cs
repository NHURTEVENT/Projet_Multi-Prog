...
namespace WindowsFormsApp
{
    public partial class FormView : Form
    {
        ...
        private void Logs_TextChanged(object sender, EventArgs e)
        {
            ...
            TextReader reader = new StreamReader(@"D:\log.txt");
        ...
        private void FormView_Load(object sender, EventArgs e)
        {
            ...
            StreamWriter deleteFile = new StreamWriter(path, true);    //writing in logfile and log file path
        ...
        private void LogMsg()
        {
            ...
            StreamWriter sw = new StreamWriter(path, true);    //writing in logfile and log file path
